        ...
        <div className="flex flex-col gap-6" data-testid="stopwatch">
          ...
          <div className="flex justify-center gap-3">
            ...
            <button
              ...
              className="rounded-md border border-border px-6 py-2 text-sm transition-colors duration-150 disabled:opacity-50 hover:bg-accent motion-reduce:transition-none"
            >
              Lap
            </button>
            <button
              type="button"
              onClick={handleReset}
              className="rounded-md border border-border px-6 py-2 text-sm transition-colors duration-150 hover:bg-accent motion-reduce:transition-none"
            >
              Reset
            </button>
          </div>
